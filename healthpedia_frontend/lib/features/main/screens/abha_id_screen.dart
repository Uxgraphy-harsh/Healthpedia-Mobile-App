...
class _AbhaIdScreenState extends State<AbhaIdScreen>
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Connect your ABHA ID to automatically import your medical records from government health facilities across India.',
      ...
      child: Row(
        ...
        children: [
          if (label.contains('Encrypted'))
            const Icon(Icons.lock_outline, size: 12, color: AppColors.green700),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildFeatureRow(
            'Auto-import Medical Records',
            'Lab reports, prescriptions, and discharge summaries from ABDM-linked facilities pulled automatically.',
            'assets/Figma MCP Assets/CommonAssets/Icons/medical_records.svg',
          ...
          _buildFeatureRow(
            ...
            'All visits, tests, and treatments from any ABDM-registered hospital in one place.',
            'assets/Figma MCP Assets/CommonAssets/Icons/health_history.svg',
          ...
          _buildFeatureRow(
            'Share with Doctors',
            'Grant consent-based access to your records at any hospital visit - no paperwork needed.',
            'assets/Figma MCP Assets/CommonAssets/Icons/share_doctors.svg',
          ...
          _buildFeatureRow(
            'AI-powered Insights',
            'Healthpedia AI can analyse your ABHA records to give you personalised health guidance.',
            'assets/Figma MCP Assets/CommonAssets/Icons/ai_insights.svg',
        ...
        children: [
          ...
          OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              minimumSize: const Size(double.infinity, 56),
              side: const BorderSide(color: AppColors.neutral950),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(99),
              ),
            ),
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Securely fetching your health records from the Ayushman Bharat network...',
                textAlign: TextAlign.center,
                style: AppTypography.label3.copyWith(
                  color: AppColors.neutral600,
                ),
      ...
      child: Row(
        children: [
          Icon(
            ...
            color: completed
                ? AppColors.green600
                : (isChecking ? AppColors.orange400 : AppColors.neutral300),
            size: 20,
          ),
          const SizedBox(width: 12),
          Text(
            ...
            style: AppTypography.label2.copyWith(
              color: completed ? AppColors.green700 : AppColors.neutral900,
              fontWeight: FontWeight.w500,
            ),
          ),
        ],
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [
            ...
            const Color(0xFFBBF7D0).withOpacity(0.8),
          ],
        ),
      ),
      child: Column(
        ...
        children: [
          ...
          Text(
            'mahesh.sahu@abdm',
            style: AppTypography.label2.copyWith(color: AppColors.green800),
          ),
          const SizedBox(height: 24),
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  Widget _buildSyncButton() {
    return Container(
      ...
      child: Row(
        children: [
          const Icon(Icons.sync, size: 16, color: AppColors.green700),
          const SizedBox(width: 4),
          Text(
            'Sync',
            style: AppTypography.label2.copyWith(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSyncHistoryItem(
            'Full Sync - 312 records',
            'Today, 7:42 AM • Initial import from ABDM',
            '+312',
            '48.2 MB',
          ),
          const Divider(),
          _buildSyncHistoryItem(
            'Thyroid Report - SRL Diagnostics',
            '14 Jan 2025, 9:10 AM',
            '+3',
            '2.4 MB',
          ),
          const Divider(),
          _buildSyncHistoryItem(
            'Prescription - Apollo Clinic Pune',
            '2 Nov 2024, 3:45 PM',
            '+5',
            '0.8 MB',
          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFacilityRow(
            'Apollo Clinic Pune',
            'Auto-sync enabled • 47 records',
            true,
          ),
          const Divider(),
          _buildFacilityRow(
            'SRL Diagnostics, Baner',
            'Auto-sync enabled • 89 records',
            true,
          ),
          const Divider(),
          _buildFacilityRow(
            'Ruby Hall Clinic',
            'Auto-sync enabled • 63 records',
            true,
          ),
          const Divider(),
